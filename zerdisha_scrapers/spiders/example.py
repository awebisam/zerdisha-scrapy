...
class ExampleSpider(scrapy.Spider):
    ...
    def start_requests(self) -> Generator[scrapy.Request, None, None]:
        ...
        This method creates the initial requests that the spider will start crawling with.
        It demonstrates proper typing and logging practices.

        Yields:
            scrapy.Request: Initial requests for crawling.
        """
        self.logger.info(
            f"Starting {self.name} spider with {len(self.start_urls)} URLs")
    ...
    def parse(self, response: Response) -> Generator[ArticleItem, None, None]:
        ...
        try:
            ...
            # Would be extracted from page
            article['author'] = "Example Author"
    ...
    def parse_article(self, response: Response) -> Generator[ArticleItem, None, None]:
        ...
        return
        yield  # Unreachable but keeps the method as a generator
